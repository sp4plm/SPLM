    ...
    def getTemplate(self):
        ...
        if 'uri' in self.argm.keys():
            ...
            if len(df) > 0:
                ...
                templ = app_api.render_page("data_navigation/PizzaTopping_inst.html", title="Пицца",
        ...
        # В остальных случаях показываем страничку со "Списком экземпляров класса и его подклассами"
            ...
            templ = app_api.render_page("data_navigation/PizzaTopping.html", title="Пицца", class_name=class_lbl,
