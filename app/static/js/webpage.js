(function( window, undefined ) {
    var WebPage = {},
        SPWP = {}; // semantic portal web page

/*
    WebPage.EventsManager = function(){
        var cls = function(p){
            var _this = this,
            _collection = {},
            _calls = {},
...
*/
    WebPage['EventsManager'] = new window._custEvents();
    if (typeof window === 'object' && typeof window.document === 'object') { window.WebPage = WebPage; }
})(window);