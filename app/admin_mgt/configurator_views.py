...
def edit_settings_view(config_name):
    ...
    return render_template('portal/config_creator.html', **tmpl_vars)


@mod.route('/configs/section/tpl')
def get_section_tpl():
    return render_template('portal/config_section.html')


@mod.route('/configs/param/tpl')
def get_param_tpl():
    return render_template('portal/config_param.html')
